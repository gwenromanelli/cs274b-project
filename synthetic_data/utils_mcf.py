...
from nflows.distributions import StandardNormal, uniform, ConditionalDiagonalNormal
from nflows.transforms import FillTriangular, RandomPermutation, MaskedSumOfSigmoidsTransform
from nflows.transforms.normalization import ActNorm
from nflows.transforms.base import CompositeTransform, InverseTransform
from nflows.transforms.matrix_transforms import TransformDiagonalSoftplus, CholeskyOuterProduct
from nflows.transforms.cholesky import PositiveDefiniteAndUnconstrained
...
def sample_W_fixed_p (model, S, T, p, n, context_size=10, sample_size=100, lambda_min_exp=-2, lambda_max_exp=1, n_iter=200):
